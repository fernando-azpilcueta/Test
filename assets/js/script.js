...
//vamos a crear variables globales para almacenar el puntaje acumulado y una variable
//que indique en qué pregunta nos encontramos.
...
function mostrarResultado(){
    ...
    //cuadro.innerHTML += `<p class='resultado_obtenido'>Has obtenido ${puntaje} puntos, lo cual significa que tu estilo de vida es ${estiloVida}.</p>`;
...
nuevaPregunta(); //Muestra la primera pregunta
